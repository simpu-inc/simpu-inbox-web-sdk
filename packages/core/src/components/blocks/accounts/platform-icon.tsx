...
export interface AccountPlatformIconProps extends FlexProps {
  platform: string;
}

export const AccountPlatformIcon = ({
  platform,
  ...rest
}: AccountPlatformIconProps) => {
  const platformIconMapping: { [key: string]: IconType } = {
    instagram: () => (
      <svg
        width="11px"
        height="11px"
  ...
  const Icon = platformIconMapping[platform];
